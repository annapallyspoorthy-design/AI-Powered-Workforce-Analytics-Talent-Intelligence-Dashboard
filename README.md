Team: Team A — Infosys Mentor: Vivek Gautam
...
🥈 Silver Layer (Clean Data) AWS Glue cleans and validates the raw data by:

Removing duplicates
Handling missing values
Standardizing formats
Performing data validation
🥇 Gold Layer (Curated Data) The cleaned data is transformed into business-ready datasets through:
...
HR forecasting
Vector Database A Vector Database stores text embeddings generated from HR documents and processed datasets. It supports:
